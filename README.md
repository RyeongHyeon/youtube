...
http gateway:8080/videoServices videoId=1 clientId=1 channelId=1 viewCount=0
http gateway:8080/videoServices videoId=2 clientId=1 channelId=1 viewCount=0
http gateway:8080/videoServices videoId=3 clientId=1 channelId=1 viewCount=0
http gateway:8080/advertisingSystems adId=1 adName="ad111" adMinute=3 adCnt=10
http gateway:8080/advertisingSystems adId=2 adName="ad222" adMinute=3 adCnt=20


### 고객이 동영상을 조회(수정)하면 맵핑된 광고의 횟수를 차감한다
http PATCH gateway:8080/videoServices/1 viewCount=5
http gateway:8080/videoServices
httpgateway:8080/advertisingSystems
